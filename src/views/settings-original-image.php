...
<tr>
    ...
    <td>
        ...
        <div class="tiny-resize-available">
            ...
            <input
                type="checkbox"
                id="<?php esc_attr_e($resize_original_enabled_id); ?>"
                name="<?php esc_attr_e($resize_original_enabled_name); ?>"
                value="on"
                <?php checked($resize_original_enabled); ?>
            />
            <label for="<?php esc_attr_e($resize_original_enabled_id); ?>">
                <?php esc_html_e(
            ...
            <div class="tiny-resize-available tiny-resize-resolution">
                ...
                <div class="tiny-resize-inputs">
                    <?php 
		            $this->render_resize_input( 'width', 'Max Width' );
                    $this->render_resize_input( 'height', 'Max Height' );
                    ?>
                </div>
            </div>
