...
<div class="conversion-options">
	<?php include( dirname( __FILE__ ) . '/settings-conversion-enabled.php' ); ?>
	...
	<fieldset
		...
		<?php
		include( dirname( __FILE__ ) . '/settings-conversion-output.php' );
		include( dirname( __FILE__ ) . '/settings-conversion-delivery.php' );
		?>
	</fieldset>
</div>
